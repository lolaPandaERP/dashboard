...
/**
 * \file    test/phpunit/TabFunctionalTest.php
 * \ingroup tab
 ...
 * @package Testtab
 */
class TabFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/tab/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('tab/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/tab/admin/about.php');
		$this->authenticate();
		return $this->assertContains('tab/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('tabwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTab_TabTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTab_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
