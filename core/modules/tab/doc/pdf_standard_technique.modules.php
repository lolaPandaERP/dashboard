...
/**
 *	Class to manage PDF template standard_technique
 */
class pdf_standard_technique extends ModelePDFTechnique
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_TECHNIQUE_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->tab->dir_output.'/technique')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->tab->dir_output.'/technique';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->tab->dir_output.'/technique/'.$objectref;
