...
/**
 *	Class to manage PDF template standard_financier
 */
class pdf_standard_financier extends ModelePDFFinancier
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_FINANCIER_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->tab->dir_output.'/financier')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->tab->dir_output.'/financier';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->tab->dir_output.'/financier/'.$objectref;
