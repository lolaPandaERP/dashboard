...
/**
 *	Class to manage PDF template standard_general
 */
class pdf_standard_general extends ModelePDFGeneral
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_GENERAL_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->tab->dir_output.'/general')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->tab->dir_output.'/general';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->tab->dir_output.'/general/'.$objectref;
