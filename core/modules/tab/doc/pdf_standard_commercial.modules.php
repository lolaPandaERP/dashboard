...
/**
 *  \file       core/modules/tab/doc/pdf_standard.modules.php
 *  \ingroup    tab
...
/**
 *	Class to manage PDF template standard_commercial
 */
class pdf_standard_commercial extends ModelePDFCommercial
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_COMMERCIAL_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->tab->dir_output.'/commercial')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->tab->dir_output.'/commercial';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->tab->dir_output.'/commercial/'.$objectref;
